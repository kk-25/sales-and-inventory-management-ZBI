...
SECRET_KEY = os.environ.get('SECRET_KEY') or os.environ.get('DJANGO_SECRET_KEY') or 'django-insecure-super-fake-ci-key-abcdefghijklmnopqrstuvwxyz1234567890ABCDEFGHIJKL'
